...
- We use trunk-based development. Create a short-lived branch off `main`, open a PR, get review, and merge.
...
- Focus: terminal-first runtime, agent SDK, and knowledge base—stay within the roadmap phases unless coordinating with maintainers.
- Coordination: open an issue before large refactors or new features; align proposals with ROADMAP milestones.

## Issues & labels

- Use our templates. Labels: bug, feature, task, docs, infra, security, design, good-first-issue, epic, phase:g.
...
- CHANGELOG is generated from `feat|fix|perf|refactor|docs|chore|ci|build|revert`.
